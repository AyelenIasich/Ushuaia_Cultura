                            ...
                            <div class=" p-0 m-0" data-bs-toggle="modal" data-bs-target="#showModalMural{{ $murale->id }}">
                                ...
                                <div class="card-body ">
                                   {{-- <h5 class="card-title text-center mt-2 mb-2 bold">{{ $murale->titulo_mural }}
                                    ...
                                    <p class="card-text text-end mb-1 bold mt-2">{{ $murale->categoriesMurale->nombre }}</p>

                                  @if (isset($murale->artists))
                                        <div class="row">
                                            <div class="col">
                                                <p>@foreach ($murale->artists as $artist)<span class="artistas-nombres me-1">{{ $artist->nombre }}</span>@endforeach</p>
                                            </div>
                                        </div>
                                    @endif
