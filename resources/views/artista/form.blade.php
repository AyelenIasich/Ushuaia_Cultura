    ...
    <div>
        ...
        <div class="row">
            <div class="col">
                ...
                <input placeholder="https://www.instagram.com/iasichjorge/" type="text" class="form-control"
        ...
        <div class="row">
            <div class="col">
                ...
                <textarea placeholder="Soy un subtitulo" type="text" class="form-control descripcionExp" name="Subtitulo"
                    id="Subtitulo" cols="30" rows="4"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col">
