<div class="box box-info padding-1 font">
    <div class="box-body">
        @hasrole('artista')
            {!! Form::hidden('artista_id', $artistaUser->id) !!}
        @endhasrole
        @hasrole('admin')
        ...
        <div class="form-group  requerido ">
            ...
            <input type="file" class="form-control " name="image_obra" accept="image/*" id="image_obra">
            @error('image_obra')
        ...
        {{-- @if (isset($galeria->image_obra))
            <div class="row">
                <div class="col mt-3">
                    <p>Nombre de obra anterior:</p><span class="small"> {{ $galeria->image_obra }}</span>
        ...
        @if (isset($galeria))
            <div class="row">
                <div class="col mt-5 mb-3 text-center">
                    <img src="{{ asset($galeria->image_obra) }}" style="width:9em" alt="">
                </div>
            </div>
        @endif
            ...
            <div class="col">
                <div class="form-group ">
                    ...
                    <textarea placeholder="Escribe aquí la descripción..." type="text" class="form-control" name="descripcion_obra"
                        id="descripcion_obra" cols="30" rows="4">
@if (isset($galeria))
{{ $galeria->descripcion_obra }}
@endif @if (!$errors->has('descripcion_obra'))
{{ old('descripcion_obra') }}
@endif
</textarea>
